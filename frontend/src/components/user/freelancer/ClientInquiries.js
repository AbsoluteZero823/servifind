...
// console.log(service.user._id)
    ...
    //   alert('gawin mo na to ken')
      ...
      dispatch(updateStatus(inquiries.inquiry._id, statusData));
 ...
 {loading ? <Loader /> : (
            ...
            {/* <p>{itoyun.instruction}</p> */}
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        {(inquiries.inquiry && inquiries.inquiry.status != 'accepted') && (
                                        <button type="submit" className="btn btn-primary" >Accept Inquiry & Start</button>
                                        )}
